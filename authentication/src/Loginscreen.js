...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as User"} primary={true} style={style} onClick={(event) => this.handleClick(event,'student')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as Developer"} primary={true} style={style} onClick={(event) => this.handleClick(event,'teacher')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      developerbuttonLabel:'Register as Developer',
      isLogin:true
    }
  }
  componentWillMount(){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
         ...
         <MuiThemeProvider>
         <div>
            <RaisedButton label={"Register as Teacher"} primary={true} style={style} onClick={(event) => this.handleClick(event,'developer')}/>
        </div>
        </MuiThemeProvider>
        </div>
      )
